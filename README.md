...
| [**chumicro-websockets**](https://github.com/ChuMicro/ChuMicro/tree/main/libraries/websockets) | 0.25.0 | Non-blocking WebSocket (RFC 6455) client and server for CircuitPython, MicroPython, and CPython. |
